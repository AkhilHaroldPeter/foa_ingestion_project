...
"""
Export utilities for writing normalized FOA records to disk.

This module handles serialization of processed funding opportunity records
into machine-readable output formats used by the project.

Supported export formats:
- JSON
- CSV

The export layer is intentionally separated from ingestion and tagging logic
to keep the pipeline modular and easier to extend in future iterations.
"""
